...
/**
 * Datadev_Jadlog_Package class.
 */
class Datadev_Jadlog_Package {
    ...
    public function get_data() {
        // Get the package data.
        $data = apply_filters('datadev_jadlog_default_package', $this->get_package_data());
        ...
        return array(
            'height' => apply_filters('datadev_jadlog_package_height', $cubage['height']),
            'width' => apply_filters('datadev_jadlog_package_width', $cubage['width']),
            'length' => apply_filters('datadev_jadlog_package_length', $cubage['length']),
            'weight' => apply_filters('datadev_jadlog_package_weight', $data['weight']),
        );
    }
